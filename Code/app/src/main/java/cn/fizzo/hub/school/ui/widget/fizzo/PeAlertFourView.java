...
public class PeAlertFourView extends LinearLayout {

    TextView tvNo;
    TextView tvName;

    public PeAlertFourView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.layout_pe_alert_four, this, true);
        tvNo = (TextView) findViewById(R.id.tv_no);
        tvName = (TextView) findViewById(R.id.tv_name);
    }

    public PeAlertFourView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.layout_pe_alert_four, this, true);
        tvNo = (TextView) findViewById(R.id.tv_no);
        tvName = (TextView) findViewById(R.id.tv_name);
