 ...
 */
public class PeReportTwoFragment extends BasePeFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_pe_report_two;
    }
    ...
    private void initHrChart() {
        ...
        float mChartMarginLeft = DeviceU.dpToPixel(70);
        ...
        xAxis.setTextSize(DeviceU.dpToPixel(16));
        ...
        leftAxis.setTextSize(DeviceU.dpToPixel(16));
...
//        leftAxis.setGridDashedLine(new DashPathEffect(new float[]{4.0f, 3.0f}, 0));
    ...
    private void updateViews() {
        ...
        if (mPeData.lesson_basic_data.density < 10) {
            ...
            tvDensity.setText((int) mPeData.lesson_basic_data.density + "%");
        }
