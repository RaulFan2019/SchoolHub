...
public class SportLessonBorderAdapter extends RecyclerView.Adapter {

    private MyOpenPresenter mPresenter;


    public SportLessonBorderAdapter(MyOpenPresenter presenter) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        SportLessonBorderAdapter.ViewHolder viewHolder = new SportLessonBorderAdapter.ViewHolder(view, presenter, presenterVh);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        SportLessonBorderAdapter.ViewHolder viewHolder = (SportLessonBorderAdapter.ViewHolder) holder;
